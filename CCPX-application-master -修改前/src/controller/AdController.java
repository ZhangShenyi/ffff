...
public class AdController {
	...
	public String uploadAd(@RequestParam("adtitle") String adtitle,HttpServletRequest req,HttpServletResponse res,MultipartFile file,HttpSession session) throws IllegalStateException, IOException
	{
...
//	            req.setAttribute("msg", "file=null");
		...
		seller= (model.seller) req.getSession().getAttribute("Seller");
